...
public class HillTrollEntity extends Monster implements GeoEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.0D, true));  // Melee combat behavior
        this.goalSelector.addGoal(7, new WaterAvoidingRandomStrollGoal(this, 0.7D));  // Random movement
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide && this.getTarget() != null && rockThrowCooldown == 0) {
            ...
            if (distance > 64.0D && distance < 400.0D) {
                throwRock();
                rockThrowCooldown = 120; // Shorter cooldown than Cave Troll
            }
        }
    }
    ...
    public boolean doHurtTarget(net.minecraft.world.entity.Entity target) {
        ...
        if (flag && target instanceof LivingEntity living) {
            if (slamCooldown == 0 && this.getRandom().nextFloat() < 0.25F) {
                ...
                slamCooldown = 80;  // Shorter cooldown than Cave Troll
            }
        }
    ...
    private void performSlam(LivingEntity target) {
        ...
        if (this.level() instanceof ServerLevel serverLevel) {
            ...
            AABB area = this.getBoundingBox().inflate(3.5D); // Larger area for slam effect
    ...
    private void throwRock() {
        ...
        rock.shoot(dx, dy + distance * 0.1D, dz, 1.3F, 7.0F);  // Adjusted rock trajectory and speed
    ...
    public float getScale() {
        return 1.25F;  // Slightly smaller than Cave Troll
    }
