...
public class ManOfNorthEntity extends Monster implements GeoEntity {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, 28.0D)      // Elite guards, very tanky
                .add(Attributes.MOVEMENT_SPEED, 0.27D)  // Slower due to heavy armor
                .add(Attributes.ATTACK_DAMAGE, 5.5D)    // Strong attacks
